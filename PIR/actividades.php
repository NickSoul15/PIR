...
<!-- <div class="content">
  ...
  <table class="table table-bordered table-striped table-warning">
        <tr>
            ...
            <td>Reportero</td>
            <td>Hora</td>
            <td><a href="registrarT.php">Asignar tarea</a></td>
            <td><a href="eliminartodo.php" onClick="javascript: return confirm('¿Deseas eliminar las tareas?');">Eliminar todo</a></td></td>
        </tr>
        <?php
include("conexion.php");
        ...
        $sql= "SELECT id,nombre,reportero,hora FROM tareas";
        ...
        <tr>
            ...
            tarea=<?php echo $mostrar['1'] ?> &
            reportero=<?php echo $mostrar['2'] ?> &
            hora=<?php echo $mostrar['3'] ?>
            ">Modificar tarea</a></td>
            <td><a href="eliminarT.php?
            id=<?php echo $mostrar['0'] ?>
            " onClick="javascript: return confirm('¿Deseas eliminar esta tarea?');">Eliminar tarea</a></td>
        </tr>
        <?php
        }
        ?>
